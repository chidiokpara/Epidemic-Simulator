...
/*----------------------------------------------------------------------------------------------------------------------*/
    ...
    show_path();
    summation();
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.10, (1.0/7.0), 0);

    cout << "Max individuals infected when infection rate is 0.10: " << (maximum * Total[1]) << " || " <<maximum << endl;
    clear();
    ...
    cout << "Max individuals infected when infection rate is 0.20: " << (maximum * Total[1]) << " || " <<maximum << endl;
    clear();
    ...
    cout << "Max individuals infected when infection rate is 0.30: " << (maximum * Total[1]) << " || " <<maximum << endl;
    clear();
    ...
    cout << "Max individuals infected when infection rate is 0.40: " << (maximum * Total[1]) << " || " <<maximum << endl;
    clear();
    ...
    cout << "Max individuals infected when infection rate is 0.50: " << (maximum * Total[1]) << " || " <<maximum << endl;
    clear();
    ...
    cout << "Max individuals infected when infection rate is 0.60: " << (maximum * Total[1]) << " || " <<maximum << endl;
    clear();
    ...
    cout << "Max individuals infected when infection rate is 0.70: " << (maximum * Total[1]) << " || " <<maximum << endl;
    clear();
    ...
    cout << "Max individuals infected when infection rate is 0.80: " << (maximum * Total[1]) << " || " <<maximum << endl;
    clear();
    ...
    cout << "Max individuals infected when infection rate is 0.90: " << (maximum * Total[1]) << " || " <<maximum << endl;
    clear();
    ...
    cout << "Max individuals infected when infection rate is 0.99: " << (maximum * Total[1]) << " || " <<maximum << endl;
    clear();

    Results[0][0] = saver;

    DataPoint("Recovery1.csv");

    /*------------------------------------------------------------------------------------------------------------------*/
    cout << "----------------------------------------------------------------------Recovery takes two weeks---------------------------------------------------------------------------" << endl;
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.10, (1.0/14.0), 0);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.20, (1.0/14.0), 1);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.30, (1.0/14.0), 2);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.40, (1.0/14.0), 3);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.50, (1.0/14.0), 4);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.60, (1.0/14.0), 5);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.70, (1.0/14.0), 6);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.80, (1.0/14.0), 7);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.90, (1.0/14.0), 8);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.99, (1.0/14.0), 9);
    ...
    DataPoint("Recovery2.csv");

    //--------------------------------------------------------------------------------------------------------------//

    cout << "-------------------------------------------------------------------------------------------------------Recovery takes three weeks------------------------------------------------------" << endl;
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.10, (1.0/21.0), 0);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.20, (1.0/21.0), 1);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.30, (1.0/21.0), 2);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.40, (1.0/21.0), 3);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.50, (1.0/21.0), 4);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.60, (1.0/21.0), 5);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.70, (1.0/21.0), 6);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.80, (1.0/21.0), 7);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.90, (1.0/21.0), 8);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.99, (1.0/21.0), 9);
    ...
    DataPoint("Recovery3.csv");

    //--------------------------------------------------------------------------------------------------------------//
    
    cout << "--------------------------------------------------------------------------------------------Recovery takes four weeks-------------------------------------------------------------------" << endl;
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.10, (1.0/28.0), 0);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.20, (1.0/28.0), 1);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.30, (1.0/28.0), 2);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.40, (1.0/28.0), 3);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.50, (1.0/28.0), 4);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.60, (1.0/28.0), 5);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.70, (1.0/28.0), 6);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.80, (1.0/28.0), 7);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.90, (1.0/28.0), 8);
    ...
    cout << "Total initial infected: " << Total[0] << endl;
    cout << "Total population: " << Total[1] << endl;
    SIR_model(Total, 0.99, (1.0/28.0), 9);
    ...
    DataPoint("Recovery4.csv");

    //--------------------------------------------------------------------------------------------------------------//
    
    

    cout << "-----------------------------------------------------------------------------------------------Half Capacity: Recovery takes two weeks-------------------------------------------------------------------------------" << endl;
